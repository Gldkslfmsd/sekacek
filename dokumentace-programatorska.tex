...
\od sekacek.py -- zdrojový kód

\od .sekacek -- pùvodní soubor výjimek, který Sekáèek otvírá otvírá pøi
ka¾dém spu¹tìní

\od dokumentace.pdf -- u¾ivatelská dokumentace

\od dokumentace-programatorska.pdf -- tato programátorská dokumentace
...
psát sám, dále je velmi struèný, jednoduchý a intuitivní, o~spoustu vìcí se
...
jako \fce sténá a \fce stìna, která by se li¹ila pouze v~diakritice a ten rozdíl by
by tedy byl snadno pøehlédnutelný, nepou¾ívám, tak¾e doufám, ¾e tato volba nikomu neublí¾í.

\n2{Jak pracuje Sekáèek?}
...
\n3{Strojové dìlení slov na slabiky}
...
Vokály jsou samohlásky, a, e, i, o, u, y, a jejich dlouhé verze. Budu je
znaèit znakem V.

Konzonanty, K, jsou souhlásky, b, f, l, m, p, s, v, z, h, ch, k, r, d, t, n
atd.
...
pro Sekáèek vyjádøí, jako by byly jen jedna slabika, pak se aplikují ostatní
pravidla.
\bigskip
...
\pr{a)} Skupiny au, ou, ai, oi a eu na záèátku slova pova¾uji za
nedìlitelné.
...
\n2{Sem se dá nìjaký vtipný nadpis}
...
neslabièná slova. Ty patøí k~nìjaké slabice, ale jsou oddìlená mezerami.
